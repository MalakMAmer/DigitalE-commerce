  ...
  return (
    <>
      ...
      <nav className="w-full bg-white/85 backdrop-blur-xl border-b border-gray-200 shadow-sm fixed top-0 left-0 z-50">
        ...
        {isOpen && (
          <>
            {/* Grey transparent overlay - disables clicking + scrolling */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 0.4 }}
              exit={{ opacity: 0 }}
            ...
            >
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="self-end text-purple-700 mb-6"
              >
                <X size={28} />
              </button>
              ...
              <div className="mt-auto flex flex-col gap-4 pt-6 border-t border-gray-200">
                ...
                <Link
                  to="/favProduct"
                  onClick={() => setIsOpen(false)}
                  className="flex justify-center items-center text-purple-700 hover:text-purple-500 py-2 rounded-md font-semibold bg-purple-100 transition-all"
                >
                  <ShoppingCart size={24} />
                </Link>
              </div>
